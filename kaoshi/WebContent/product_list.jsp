...
<script type="text/javascript">
	...
	$(function(){
		...
		var params = {"method":"findNewPro"};
		$.post(url,params,function(data){
			// alert(data);
			// 获取列表对象
			var $uidObj = $("#bid");
			$(data).each(function(index,ele){
				// alert(ele.cid+"  "+ele.cname);
				$uidObj.append("<li><a href='${pageContext.request.contextPath}/product?method=findNewProAndPage&cid="+ele.cid+"&pageNumber=1'>"+ele.cname+"</a></li>");
			});
		},"json");
	});
</script>
		...
		<table width="100%" border="0" cellspacing="0">
						...
						<tr>
							<td>
								...
								<div style="margin-top:20px; margin-bottom:5px">
									...
									href="${pageContext.request.contextPath }/servlet/findBookInfoServlet?id=${b.id}" />
								</div>

								<table cellspacing="0" class="booklist" id="bid">
									<tr>
								<c:forEach items="${books.data }" var="b">
										<td>
			...
			<c:forEach items="${books }" var="b">							
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td>${b.category }</td>
									<td><a
										href="${pageContext.request.contextPath}/servlet?method=findNewPro">
											<img
											src="${pageContext.request.contextPath}/${b.images}"
											border="0" style="CURSOR: hand">展示 </a>
									</td>
